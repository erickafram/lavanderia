...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        <div class="glass-effect rounded-2xl shadow-xl p-6 border">
            <form method="POST" action="{{ route('acompanhamento.buscar') }}" class="space-y-4">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        <input type="text" 
                               ...
                               name="busca" 
                               value="{{ old('busca') }}"
                               class="w-full px-4 py-3 text-base border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-gray-50 hover:bg-white group-hover:border-gray-300 @error('busca') border-red-500 @enderror"
