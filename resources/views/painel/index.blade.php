            ...
            <div id="coletas-list-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                @foreach($coletasAcompanhamento as $coleta)
                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
                         onclick="acompanharColetaPorId({{ json_encode($coleta->numero_coleta) }})">
                        ...
                        <div class="mb-2 flex items-center text-xs text-blue-600">
                            ...
                            <span class="font-medium">Tempo total: {{ $tempoTotal }}</span>
                        </div>
                        @endif
                        ...
                        <div class="grid grid-cols-5 gap-1 text-xs">
                            <div class="flex flex-col items-center {{ $progresso['coleta']['concluida'] ? 'text-green-600' : 'text-gray-400' }}">
                                <svg class="w-3 h-3 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Coleta</span>
                            </div>
                            <div class="flex flex-col items-center {{ $progresso['pesagem']['concluida'] ? 'text-green-600' : 'text-gray-400' }}">
                                <svg class="w-3 h-3 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Pesagem</span>
                            </div>
                            <div class="flex flex-col items-center {{ $progresso['empacotamento']['concluida'] ? 'text-green-600' : 'text-gray-400' }}">
                                <svg class="w-3 h-3 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Empac.</span>
                            </div>
                            <div class="flex flex-col items-center {{ $progresso['entrega']['concluida'] ? 'text-green-600' : 'text-gray-400' }}">
                                <svg class="w-3 h-3 mb-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                </svg>
                                <span>Trânsito</span>
