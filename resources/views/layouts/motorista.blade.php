                ...
                <div class="flex-1 px-4 py-6 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-6">
                            ...
                            <a href="{{ route('motorista.dashboard') }}" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 {{ request()->routeIs('motorista.dashboard') ? 'bg-green-50 text-green-700 border-r-2 border-green-600' : '' }}">
                                <div class="flex items-center justify-center w-10 h-10 rounded-lg {{ request()->routeIs('motorista.dashboard') ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
