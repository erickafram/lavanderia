    ...
    <div class="flex min-h-screen">
        ...
        <nav id="sidebar" class="fixed lg:static inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 shadow-lg transform -translate-x-full lg:translate-x-0 transition-all duration-300 ease-in-out sidebar-no-transition">
            <div class="flex flex-col h-full">
                ...
                <div class="px-4 py-4 border-b border-gray-200 bg-white">
                    <div class="flex items-center justify-between logo-container">
                        ...
                        <button onclick="toggleSidebar()" class="hidden lg:flex items-center justify-center w-8 h-8 rounded-lg hover:bg-gray-100 transition-colors" title="Expandir/Recolher menu">
                            <svg id="collapseIcon" class="w-5 h-5 text-gray-600 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Menu Principal -->
                <div class="flex-1 px-4 py-4 overflow-y-auto bg-white text-sm menu-section">
                    <div class="space-y-3">
                        @php
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-1.5">
                                <a href="{{ route('painel') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('painel') ? 'menu-item-active bg-blue-50' : '' }}" title="Dashboard">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('painel') ? '' : 'bg-gray-50 text-gray-600' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 5a2 2 0 012-2h4a2 2 0 012 2v3H8V5z"></path>
                                        </svg>
                                    </div>
                                    <div class="ml-3 leading-tight sidebar-text">
                                        <p class="font-semibold">Dashboard</p>
                                        <p class="text-[11px] text-gray-500">Visão geral do sistema</p>
                                    </div>
                                </a>
                                <a href="{{ route('acompanhar-coletas') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('acompanhar-coletas') ? 'menu-item-active bg-blue-50' : '' }}" title="Acompanhar Coletas">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('acompanhar-coletas') ? '' : 'bg-gray-50 text-gray-600' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <a href="{{ route('estabelecimentos.index') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('estabelecimentos.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Estabelecimentos">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('estabelecimentos.*') ? '' : 'bg-gray-50 text-gray-600' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('coletas.index') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('coletas.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Coletas">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('coletas.*') ? '' : 'bg-gray-50 text-gray-600' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('pesagem.index') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('pesagem.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Pesagem">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('pesagem.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('empacotamento.index') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('empacotamento.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Empacotamento">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('empacotamento.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('motorista.dashboard') }}" class="menu-item group flex items-center px-3 py-2.5 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('motorista.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Entregas">
                                    <div class="menu-icon-wrapper w-9 h-9 rounded-lg {{ request()->routeIs('motorista.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="ml-3 leading-tight sidebar-text">
                                        ...
                                        <p class="text-[11px] text-gray-500">Gestão de entregas</p>
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('tipos.index') }}" class="menu-item group flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 {{ request()->routeIs('tipos.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Tipos de Peças">
                                    <div class="menu-icon-wrapper w-10 h-10 rounded-xl {{ request()->routeIs('tipos.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('usuarios.index') }}" class="menu-item group flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 {{ request()->routeIs('usuarios.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Usuários">
                                    <div class="menu-icon-wrapper w-10 h-10 rounded-xl {{ request()->routeIs('usuarios.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('relatorios.index') }}" class="menu-item group flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 {{ request()->routeIs('relatorios.*') ? 'menu-item-active bg-blue-50' : '' }}" title="Relatórios">
                                    <div class="menu-icon-wrapper w-10 h-10 rounded-xl {{ request()->routeIs('relatorios.*') ? '' : 'bg-gray-50 text-gray-500' }} transition-all duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Menu do usuário -->
                <div class="p-4 border-t border-gray-200 bg-white user-menu-container">
                    <div class="relative">
                        <div class="flex items-center px-3 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg transition-all duração-200 cursor-pointer" onclick="toggleUserMenu()">
                            ...
                            <div class="ml-3 flex-1 leading-tight sidebar-text">
                            ...
                            <svg class="w-4 h-4 text-gray-400 transition-transform duração-200 sidebar-text" id="userMenuIcon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
