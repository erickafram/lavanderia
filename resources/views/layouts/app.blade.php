                ...
                <div class="flex-1 px-3 py-4 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-1">
                                <a href="{{ route('painel') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('painel') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('painel') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                ...
                                <a href="{{ route('acompanhar-coletas') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('acompanhar-coletas') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('acompanhar-coletas') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    @if(request()->routeIs('acompanhar-coletas'))
                                    <div class="ml-auto w-2 h-2 bg-blue-600 rounded-full"></div>
                                    @endif
                                </a>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('estabelecimentos.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('estabelecimentos.*') ? 'bg-emerald-50 text-emerald-700 border-r-2 border-emerald-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('estabelecimentos.*') ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('coletas.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('coletas.*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('coletas.*') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('pesagem.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('pesagem.*') ? 'bg-orange-50 text-orange-700 border-r-2 border-orange-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('pesagem.*') ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('empacotamento.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('empacotamento.*') ? 'bg-purple-50 text-purple-700 border-r-2 border-purple-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('empacotamento.*') ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('motorista.dashboard') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('motorista.*') ? 'bg-green-50 text-green-700 border-r-2 border-green-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('motorista.*') ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('usuarios.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('usuarios.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('usuarios.*') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="{{ route('relatorios.index') }}" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 {{ request()->routeIs('relatorios.*') ? 'bg-slate-50 text-slate-700 border-r-2 border-slate-600' : '' }}">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg {{ request()->routeIs('relatorios.*') ? 'bg-slate-100 text-slate-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200' }} transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
