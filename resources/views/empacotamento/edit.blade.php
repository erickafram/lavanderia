                                    ...
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="text-xs text-gray-500">{{ $peca->tipo ? $peca->tipo->categoria : '' }}</div>
                                                    @if($peca->observacoes)
                                                        <div class="text-xs text-gray-400">{{ Str::limit($peca->observacoes, 30) }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <input type="number"
                                                   ...
                                                   value="{{ old('pecas_individuais.'.$peca->id.'.quantidade', $peca->quantidade) }}"
                                                   min="1"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <input type="number"
                                                   name="pecas_individuais[{{ $peca->id }}][peso]"
                                                   value="{{ old('pecas_individuais.'.$peca->id.'.peso', number_format($peca->peso, 3, '.', '')) }}"
                                                   step="0.001"
                                                   min="0"
                                                   class="w-20 px-2 py-1 text-center border border-gray-300 rounded text-sm focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500">
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            @if(str_contains($peca->observacoes, 'Peça empacotada'))
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                    Original
                                                </span>
                                            @elseif(str_contains($peca->observacoes, 'Peça duplicada'))
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    📋 Duplicada
                                                </span>
                                            @elseif(str_contains($peca->observacoes, 'Peça extra'))
