...
<?php $__env->startSection('title', 'Novo Usuário - Sistema de Gestão de Lavanderia'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <form method="POST" action="<?php echo e(route('usuarios.store')); ?>" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderianovo\resources\views/usuarios/create.blade.php ENDPATH**/ ?>