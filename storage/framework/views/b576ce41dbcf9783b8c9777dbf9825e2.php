                    ...
                    <div class="flex items-center space-x-2">
                        <div class="flex items-center space-x-2 bg-blue-100 rounded-full px-3 py-1">
                            ...
                            <span class="text-sm font-medium text-blue-700">
                                <?php echo e($coletas->count()); ?> coleta(s) encontrada(s)
                            </span>
                        </div>
                        <span class="text-gray-400">•</span>
                        <span class="text-gray-600 text-sm">
                            Termo: <strong class="text-gray-900">"<?php echo e($termoBusca); ?>"</strong>
                        </span>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    ...
                    <div class="p-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-blue-50/30">
                        ...
                        <div class="grid grid-cols-5 gap-1">
                            <div class="flex flex-col items-center">
                                <div class="w-4 h-4 rounded-full <?php echo e($progressoEtapas['coleta'] ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center">
                                ...
                                <span class="text-xs mt-1 <?php echo e($progressoEtapas['coleta'] ? 'text-green-600' : 'text-gray-400'); ?>">Col.</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-4 h-4 rounded-full <?php echo e($progressoEtapas['pesagem'] ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center">
                                ...
                                <span class="text-xs mt-1 <?php echo e($progressoEtapas['pesagem'] ? 'text-green-600' : 'text-gray-400'); ?>">Pes.</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-4 h-4 rounded-full <?php echo e($progressoEtapas['empacotamento'] ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center">
                                ...
                                <span class="text-xs mt-1 <?php echo e($progressoEtapas['empacotamento'] ? 'text-green-600' : 'text-gray-400'); ?>">Emp.</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-4 h-4 rounded-full <?php echo e($progressoEtapas['entrega'] ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center">
                                ...
                                <span class="text-xs mt-1 <?php echo e($progressoEtapas['entrega'] ? 'text-green-600' : 'text-gray-400'); ?>">Trân.</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <div class="w-4 h-4 rounded-full <?php echo e($progressoEtapas['confirmacao_cliente'] ? 'bg-green-500' : 'bg-gray-300'); ?> flex items-center justify-center">
                                ...
                                <span class="text-xs mt-1 <?php echo e($progressoEtapas['confirmacao_cliente'] ? 'text-green-600' : 'text-gray-400'); ?>">Entr.</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900"><?php echo e($coleta->created_at->format('d/m/Y')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-bold text-gray-900 text-sm"><?php echo e($coleta->estabelecimento->cnpj_formatado ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-100">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="text-center">
                                        <p class="text-blue-800 font-bold text-lg"><?php echo e(number_format($coleta->pesagens->sum('peso'), 2, ',', '.')); ?></p>
                                        <p class="text-blue-600 text-xs font-medium">kg</p>
                                    </div>
                                    <div class="text-center">
                                        <p class="text-blue-800 font-bold text-lg"><?php echo e($coleta->pesagens->sum('quantidade')); ?></p>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-100">
                                ...
                                <div class="space-y-2">
                                    <div class="bg-white rounded-lg p-2">
                                        <p class="text-green-800 font-mono text-xs"><?php echo e($empacotamento->codigo_qr); ?></p>
                                    </div>
                                ...
                                <div class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border border-emerald-100">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-emerald-600 text-xs">
                                            Recebido por: <?php echo e($empacotamento->entrega->nome_recebedor ?? 'N/A'); ?>
