    ...
    <div class="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-4">
        <div class="flex items-start">
            ...
            <div class="flex-1">
                ...
                <?php if(session('show_force_completion')): ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    ...
    <div class="text-center py-12">
        <div class="relative">
            ...
            <?php endif; ?>
            <svg class="mx-auto h-12 w-12 <?php echo e($coleta->status->nome == 'Agendada' ? 'text-yellow-400' : 'text-gray-400'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
            </svg>
        </div>
        <h3 class="mt-2 text-sm font-medium <?php echo e($coleta->status->nome == 'Agendada' ? 'text-yellow-900' : 'text-gray-900'); ?>">
