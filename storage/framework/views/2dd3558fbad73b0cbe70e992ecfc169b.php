...
<?php $__env->startSection('title', 'Editar Estabelecimento - Sistema de Gestão de Lavanderia'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <form method="POST" action="<?php echo e(route('estabelecimentos.update', $estabelecimento->id)); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="cnpj" 
                           name="cnpj" 
                           value="<?php echo e(old('cnpj', $estabelecimento->cnpj_formatado)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="ativo" 
                        ...
                        <option value="1" <?php echo e(old('ativo', $estabelecimento->ativo) == '1' ? 'selected' : ''); ?>>Ativo</option>
                        <option value="0" <?php echo e(old('ativo', $estabelecimento->ativo) == '0' ? 'selected' : ''); ?>>Inativo</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="razao_social" 
                           name="razao_social" 
                           value="<?php echo e(old('razao_social', $estabelecimento->razao_social)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="nome_fantasia" 
                           name="nome_fantasia" 
                           value="<?php echo e(old('nome_fantasia', $estabelecimento->nome_fantasia)); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="cep" 
                           name="cep" 
                           value="<?php echo e(old('cep', $estabelecimento->cep)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           id="endereco" 
                           name="endereco" 
                           value="<?php echo e(old('endereco', $estabelecimento->endereco)); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           id="numero" 
                           name="numero" 
                           value="<?php echo e(old('numero', $estabelecimento->numero)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                           id="complemento" 
                           name="complemento" 
                           value="<?php echo e(old('complemento', $estabelecimento->complemento)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           id="bairro" 
                           name="bairro" 
                           value="<?php echo e(old('bairro', $estabelecimento->bairro)); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           id="cidade" 
                           name="cidade" 
                           value="<?php echo e(old('cidade', $estabelecimento->cidade)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        ?>
                        <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($uf); ?>" <?php echo e(old('estado', $estabelecimento->estado) == $uf ? 'selected' : ''); ?>><?php echo e($uf); ?></option>
        ...
        <div>
            ...
            <div class="mb-6">
                ...
                <input type="text"
                       id="telefone"
                       name="telefone"
                       value="<?php echo e(old('telefone', $estabelecimento->telefone)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <div id="emails-container">
                    <?php if(old('emails') || $estabelecimento->emails): ?>
                        <?php $__currentLoopData = old('emails', $estabelecimento->emails ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <div id="contatos-container">
                    <?php if(old('contatos_responsaveis') || $estabelecimento->contatos_responsaveis): ?>
                        <?php $__currentLoopData = old('contatos_responsaveis', $estabelecimento->contatos_responsaveis ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $contato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="contato-item border border-gray-200 rounded-lg p-4 mb-3">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="text-sm font-medium text-gray-700">Contato <?php echo e($index + 1); ?></h4>
                                <button type="button"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text"
                                           name="contatos_responsaveis[<?php echo e($index); ?>][nome]"
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           name="contatos_responsaveis[<?php echo e($index); ?>][telefone]"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('observacoes', $estabelecimento->observacoes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderianovo\resources\views/estabelecimentos/edit.blade.php ENDPATH**/ ?>