                ...
                <div class="flex-1 px-3 py-4 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-4">
                            ...
                            <a href="<?php echo e(route('motorista.dashboard')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('motorista.dashboard') ? 'bg-green-50 text-green-700 border-r-2 border-green-600' : ''); ?>">
                                <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('motorista.dashboard') ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
