...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        ...
        <div class="flex flex-wrap gap-2 mt-3 sm:mt-0">
            <?php if($empacotamento->status->nome !== 'Entregue'): ?>
                <?php if($empacotamento->status->nome === 'Pronto para entrega'): ?>
            ...
            <a href="<?php echo e(route('empacotamento.etiqueta', $empacotamento->id)); ?>"
               target="_blank"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
            ...
            <?php if($empacotamento->coleta->pecas->count() > 0 || $empacotamento->pecasIndividuais->count() > 0): ?>
                                    ...
                                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <?php if($peca->observacoes): ?>
                                                        <div class="text-xs text-gray-500"><?php echo e(Str::limit($peca->observacoes, 30)); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                                <?php echo e($peca->quantidade); ?> peça<?php echo e($peca->quantidade > 1 ? 's' : ''); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-900 font-medium">
                                            <?php echo e(number_format($peca->peso, 3, ',', '.')); ?>

                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-center">
                                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($peca->tipo ? $peca->tipo->categoria : 'N/A'); ?>
                            ...
                            <tfoot class="bg-gray-50">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                                        <?php echo e($empacotamento->pecasIndividuais->sum('quantidade')); ?> peças
                                    </td>
                                    <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                                        <?php echo e(number_format($empacotamento->pecasIndividuais->sum('peso'), 3, ',', '.')); ?> kg
                                    </td>
                                    <td class="px-6 py-4 text-center text-sm font-bold text-gray-900">
                                        <?php echo e($empacotamento->pecasIndividuais->groupBy('tipo.categoria')->count()); ?> categorias
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
...
function concluirEmpacotamento() {
    if (confirm('Tem certeza que deseja concluir este empacotamento? Ele ficará pronto para o motorista.')) {
        ...
        fetch('<?php echo e(route("empacotamento.concluir", $empacotamento->id)); ?>', {
            method: 'PUT',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderia\resources\views/empacotamento/show.blade.php ENDPATH**/ ?>