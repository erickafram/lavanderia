        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-6 text-center">
                    <div class="mb-4">
                        <?php echo QrCode::size(150)->generate($empacotamento->codigo_qr); ?>

                    </div>
                    <div class="text-lg font-mono font-bold text-gray-900 mb-2">
                        <?php echo e($empacotamento->codigo_qr); ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <?php elseif($empacotamento->status->nome === 'Em trânsito'): ?>
                        ...
                        <?php elseif($empacotamento->status->nome === 'Entregue'): ?>
                        ...
                        <a href="<?php echo e(url('/rastreamento/' . $empacotamento->codigo_qr)); ?>" 
                           target="_blank"
