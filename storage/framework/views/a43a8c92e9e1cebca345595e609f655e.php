...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        ...
        <div class="flex gap-2 mt-3 sm:mt-0">
            <a href="<?php echo e(route('pesagem.create-comparacao')); ?>"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('pesagem.store-geral')); ?>" id="formPesagem">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Observações gerais sobre a pesagem..."><?php echo e(old('observacoes_gerais')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderia\resources\views/pesagem/create.blade.php ENDPATH**/ ?>