            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="email"
                               class="w-full pl-12 pr-4 py-3.5 bg-white border border-primary-200 rounded-xl focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all duration-200 placeholder-primary-400 <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="password"
                               class="w-full pl-12 pr-4 py-3.5 bg-white border border-primary-200 rounded-xl focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 transition-all duration-200 placeholder-primary-400 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 focus:border-red-500 focus:ring-red-500/20 <?php unset($message);
