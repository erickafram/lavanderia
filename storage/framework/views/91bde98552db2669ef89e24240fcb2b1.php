                ...
                ?>
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-600"><?php echo e(Str::limit($coleta->estabelecimento->razao_social, 25)); ?></p>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-2 rounded-full transition-all duration-500" style="width: <?php echo e($percentual); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-5 gap-1">
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['coleta']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center <?php echo e($progresso['coleta']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="coleta">
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['pesagem']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center <?php echo e($progresso['pesagem']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="pesagem">
                                <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['empacotamento']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center <?php echo e($progresso['empacotamento']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="empacotamento">
                                <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['entrega']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center <?php echo e($progresso['entrega']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="entrega">
                                <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['confirmacao_cliente']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-5 h-5 rounded-full flex items-center justify-center <?php echo e($progresso['confirmacao_cliente']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="confirmacao_cliente">
                                <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
