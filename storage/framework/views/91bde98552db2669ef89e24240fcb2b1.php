<?php $__env->startSection('title', 'Acompanhar Coletas - Sistema de Gestão de Lavanderia'); ?>
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
    ...
    <div class="flex items-center space-x-2 mt-3 sm:mt-0">
        ...
        <span id="last-update" class="text-xs text-gray-500">Última atualização: <?php echo e(now()->format('H:i:s')); ?></span>
    </div>
</div>
    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-4 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold" data-card="total-coletas"><?php echo e(number_format($totalColetas)); ?></p>
            </div>
    ...
    <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-lg p-4 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold" data-card="total-andamento"><?php echo e(number_format($totalAndamento)); ?></p>
                <p class="text-orange-200 text-xs mt-1"><?php echo e(number_format($coletasAndamento->count())); ?> este mês</p>
            </div>
            <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg p-4 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold" data-card="total-concluidas"><?php echo e(number_format($totalConcluidas)); ?></p>
                <p class="text-green-200 text-xs mt-1"><?php echo e(number_format($coletasConcluidas->count())); ?> este mês</p>
            </div>
            <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white rounded-lg shadow-lg border border-gray-100 p-4">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex items-center space-x-1 text-xs text-gray-500">
            ...
            <span><?php echo e(now()->format('M/Y')); ?></span>
        </div>
    </div>
    ...
    <div class="mb-4">
        <nav class="flex space-x-3" aria-label="Tabs">
            <button onclick="mostrarAba('andamento')" id="tab-andamento"
                ...
                Em Andamento (<?php echo e($coletasAndamento->count()); ?>)
            </button>
            <button onclick="mostrarAba('concluidas')" id="tab-concluidas"
                ...
                Concluídas (<?php echo e($coletasConcluidas->count()); ?>)
            </button>
        </nav>
    </div>
    ...
    <div id="aba-andamento" class="tab-content">
        <?php if($coletasAndamento->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4" id="coletas-grid-andamento">
                <?php $__currentLoopData = $coletasAndamento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coleta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-105"
                     data-coleta-id="<?php echo e($coleta->id); ?>"
                     onclick="acompanharColetaPorId('<?php echo e($coleta->numero_coleta); ?>')">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900"><?php echo e($coleta->numero_coleta); ?></h3>
                            <p class="text-gray-600"><?php echo e(Str::limit($coleta->estabelecimento->razao_social, 30)); ?></p>
                            <p class="text-xs text-gray-500 mt-1"><?php echo e($coleta->created_at->format('d/m/Y H:i')); ?></p>
                        </div>
                    ...
                    <div class="mb-4 flex items-center text-sm text-blue-600 bg-blue-50 rounded-lg p-2">
                        ...
                        <span class="font-medium"><?php echo e($tempoTotal); ?></span>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between text-xs text-gray-600 mb-2">
                            <span>Progresso</span>
                            <span data-etapas><?php echo e($etapasConcluidas); ?>/5</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2.5">
                            <div class="bg-gradient-to-r from-blue-500 to-blue-600 h-2.5 rounded-full transition-all duration-500" style="width: <?php echo e($percentual); ?>%"></div>
                        </div>
                    </div>

                    <!-- Mini Etapas -->
                    <div class="grid grid-cols-5 gap-1">
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['coleta']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center <?php echo e($progresso['coleta']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="coleta">
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['pesagem']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center <?php echo e($progresso['pesagem']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="pesagem">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['empacotamento']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center <?php echo e($progresso['empacotamento']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="empacotamento">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['entrega']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center <?php echo e($progresso['entrega']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="entrega">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                        ...
                        <div class="flex flex-col items-center text-xs <?php echo e($progresso['confirmacao_cliente']['concluida'] ? 'text-green-600' : 'text-gray-400'); ?>">
                            <div class="w-6 h-6 rounded-full flex items-center justify-center <?php echo e($progresso['confirmacao_cliente']['concluida'] ? 'bg-green-100' : 'bg-gray-100'); ?> mb-1" data-etapa="confirmacao_cliente">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
    ...
    <div id="aba-concluidas" class="tab-content hidden">
        <?php if($coletasConcluidas->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4" id="coletas-grid-concluidas">
                <?php $__currentLoopData = $coletasConcluidas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coleta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        // Calcular progresso e tempos
                        $dataColeta = $coleta->created_at;
                        $dataPesagem = $coleta->pesagens->first()?->created_at;
...
function acompanharColetaPorId(numeroColeta) {
    ...
    fetch('<?php echo e(route("acompanhar-coleta")); ?>', {
        method: 'POST',
        headers: {
...
async function atualizarDadosTempoReal() {
    ...
    try {
        const response = await fetch('<?php echo e(route("acompanhar-coletas")); ?>?ajax=1&_token=<?php echo e(csrf_token()); ?>', {
            method: 'GET',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderia\resources\views/acompanhar-coletas/index.blade.php ENDPATH**/ ?>