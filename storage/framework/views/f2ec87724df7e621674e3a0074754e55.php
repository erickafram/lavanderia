                                ...
                                <?php $__currentLoopData = $pesagem->coleta->pecas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <?php echo e($peca->tipo ? $peca->tipo->nome : 'Tipo não definido'); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">R$ <?php echo e(number_format($peca->preco_unitario ?? 0, 2, ',', '.')); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">R$ <?php echo e(number_format($peca->subtotal ?? 0, 2, ',', '.')); ?></td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderia\resources\views/pesagem/show.blade.php ENDPATH**/ ?>