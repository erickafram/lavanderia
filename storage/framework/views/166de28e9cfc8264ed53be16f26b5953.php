                    ...
                    <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
                        ...
                        <div class="flex justify-between items-start mb-3">
                            <div>
                                ...
                                <p class="text-sm text-gray-600"><?php echo e(Str::limit($coleta->estabelecimento->razao_social, 30)); ?></p>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($percentual); ?>%"></div>
                            </div>
                        </div>
