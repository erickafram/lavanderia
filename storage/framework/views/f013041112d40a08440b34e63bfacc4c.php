                ...
                <div class="flex-1 px-4 py-6 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-6">
                            ...
                            <a href="<?php echo e(route('relatorios.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('relatorios.*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('relatorios.*') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
