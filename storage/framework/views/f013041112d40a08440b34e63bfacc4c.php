                ...
                <div class="flex-1 px-4 py-6 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-6">
                            ...
                            <a href="<?php echo e(route('painel')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('painel') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('painel') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="<?php echo e(route('estabelecimentos.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('estabelecimentos.*') ? 'bg-emerald-50 text-emerald-700 border-r-2 border-emerald-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('estabelecimentos.*') ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('coletas.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('coletas.*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('coletas.*') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('pesagem.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('pesagem.*') ? 'bg-orange-50 text-orange-700 border-r-2 border-orange-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('pesagem.*') ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('empacotamento.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('empacotamento.*') ? 'bg-purple-50 text-purple-700 border-r-2 border-purple-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('empacotamento.*') ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('motorista.dashboard')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('motorista.*') ? 'bg-green-50 text-green-700 border-r-2 border-green-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('motorista.*') ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="<?php echo e(route('usuarios.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('usuarios.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('usuarios.*') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('relatorios.index')); ?>" class="group flex items-center px-4 py-3 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('relatorios.*') ? 'bg-slate-50 text-slate-700 border-r-2 border-slate-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-lg <?php echo e(request()->routeIs('relatorios.*') ? 'bg-slate-100 text-slate-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
