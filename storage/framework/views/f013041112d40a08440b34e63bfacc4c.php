            ...
            <div class="flex flex-col h-full">
                ...
                <div class="flex-1 px-3 py-4 overflow-y-auto">
                    <div class="space-y-2">
                        ...
                        <div class="mb-4">
                            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-3">Principal</h3>
                            <div class="space-y-1">
                                <a href="<?php echo e(route('painel')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('painel') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('painel') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                    ...
                                    <?php if(request()->routeIs('painel')): ?>
                                    <div class="ml-auto w-2 h-2 bg-blue-600 rounded-full"></div>
                                    <?php endif; ?>
                                </a>

                                <a href="<?php echo e(route('acompanhar-coletas')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('acompanhar-coletas') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('acompanhar-coletas') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                                        </svg>
                                    </div>
                                    <div class="ml-3">
                                        <p class="font-medium">Acompanhar Coletas</p>
                                        <p class="text-xs text-gray-400 group-hover:text-gray-500">Monitorar progresso</p>
                                    </div>
                                    <?php if(request()->routeIs('acompanhar-coletas')): ?>
                                    <div class="ml-auto w-2 h-2 bg-blue-600 rounded-full"></div>
                                    <?php endif; ?>
                                </a>
                            </div>
                        ...
                        <?php if(!auth()->user()->nivelAcesso || auth()->user()->nivelAcesso->nome !== 'Motorista'): ?>
                        <div class="mb-4">
                            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-3">Operações</h3>
                            <div class="space-y-1">
                                <?php if(auth()->user()->temPermissao('estabelecimentos.visualizar')): ?>
                                <a href="<?php echo e(route('estabelecimentos.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('estabelecimentos.*') ? 'bg-emerald-50 text-emerald-700 border-r-2 border-emerald-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('estabelecimentos.*') ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <?php if(request()->routeIs('estabelecimentos.*')): ?>
                                ...
                                <a href="<?php echo e(route('coletas.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('coletas.*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('coletas.*') ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <?php if(request()->routeIs('coletas.*')): ?>
                                    <div class="ml-auto w-2 h-2 bg-blue-600 rounded-full"></div>
                                    <?php endif; ?>
                                </a>
                                <?php endif; ?>
                                ...
                                <a href="<?php echo e(route('pesagem.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('pesagem.*') ? 'bg-orange-50 text-orange-700 border-r-2 border-orange-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('pesagem.*') ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('empacotamento.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('empacotamento.*') ? 'bg-purple-50 text-purple-700 border-r-2 border-purple-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('empacotamento.*') ? 'bg-purple-100 text-purple-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('motorista.dashboard')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('motorista.*') ? 'bg-green-50 text-green-700 border-r-2 border-green-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('motorista.*') ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="ml-3">
                                        <p class="font-medium">Motorista</p>
                                        <p class="text-xs text-gray-400 group-hover:text-gray-500">Entregas e QR Code</p>
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="<?php echo e(route('usuarios.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('usuarios.*') ? 'bg-indigo-50 text-indigo-700 border-r-2 border-indigo-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('usuarios.*') ? 'bg-indigo-100 text-indigo-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="<?php echo e(route('relatorios.index')); ?>" class="group flex items-center px-3 py-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-all duration-200 <?php echo e(request()->routeIs('relatorios.*') ? 'bg-slate-50 text-slate-700 border-r-2 border-slate-600' : ''); ?>">
                                    <div class="flex items-center justify-center w-8 h-8 rounded-lg <?php echo e(request()->routeIs('relatorios.*') ? 'bg-slate-100 text-slate-600' : 'bg-gray-100 text-gray-500 group-hover:bg-gray-200'); ?> transition-colors duration-200">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
