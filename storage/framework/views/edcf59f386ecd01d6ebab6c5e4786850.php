...
<div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalProntos); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalEmTransito); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalEntreguesHoje); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($totalEntreguesMotorista); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div id="content-prontos" class="tab-content">
            <div class="p-6">
                <?php if($empacotamentosProntos->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $empacotamentosProntos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empacotamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <div class="flex items-center mb-2">
                                            <span class="text-lg font-bold text-gray-900 mr-3"><?php echo e($empacotamento->codigo_qr); ?></span>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($empacotamento->coleta->numero_coleta); ?>

                                            </span>
                                        </div>
                                        <p class="text-gray-700 font-medium"><?php echo e($empacotamento->coleta->estabelecimento->razao_social); ?></p>
                                        <p class="text-sm text-gray-500"><?php echo e($empacotamento->data_empacotamento->format('d/m/Y H:i')); ?></p>
                                    </div>
        ...
        <div id="content-transito" class="tab-content hidden">
            <div class="p-6">
                <?php if($empacotamentosEmTransito->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $empacotamentosEmTransito; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empacotamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        <div class="flex items-center mb-2">
                                        ...
                                        <p class="text-gray-700 font-medium"><?php echo e($empacotamento->coleta->estabelecimento->razao_social); ?></p>
                                        <p class="text-sm text-gray-500">Saída: <?php echo e($empacotamento->data_saida->format('d/m/Y H:i')); ?></p>
                                    </div>
                                    <button onclick="abrirModalEntrega(<?php echo e($empacotamento->id); ?>)" 
        ...
        <div id="content-entregues" class="tab-content hidden">
            <div class="p-6">
                <?php if($empacotamentosEntregues->count() > 0): ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $empacotamentosEntregues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empacotamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 rounded-lg p-4 bg-green-50">
                                <div class="flex justify-between items-start">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-gray-700 font-medium"><?php echo e($empacotamento->coleta->estabelecimento->razao_social); ?></p>
                                        <p class="text-sm text-gray-500">Entregue: <?php echo e($empacotamento->data_entrega->format('d/m/Y H:i')); ?></p>
                                    </div>
