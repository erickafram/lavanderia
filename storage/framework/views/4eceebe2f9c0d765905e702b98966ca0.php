...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <?php if($totalLotes > 0): ?>
                            ...
                            <div class="mt-4 p-3 bg-gray-50 rounded border border-gray-200">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-xs text-gray-600"><?php echo e($lotesProcessados); ?>/<?php echo e($totalLotes); ?> concluídos</span>
                                </div>

                                <!-- Barra de Progresso -->
                                <div class="w-full bg-gray-200 rounded-full h-2 mb-3">
                                    <div class="bg-green-600 h-2 rounded-full transition-all duration-300"
                                         style="width: <?php echo e($totalLotes > 0 ? ($lotesProcessados / $totalLotes) * 100 : 0); ?>%"
                                         id="barra-progresso"></div>
                                </div>

                                <div class="grid grid-cols-3 gap-4 text-center">
                                    <div class="bg-white p-2 rounded border">
                                        <div class="text-lg font-bold text-gray-900" id="contador-total"><?php echo e($totalLotes); ?></div>
                                        <div class="text-xs text-gray-600">Total</div>
                                    </div>
                                    <div class="bg-white p-2 rounded border">
                                        <div class="text-lg font-bold text-green-600" id="contador-processados"><?php echo e($lotesProcessados); ?></div>
                                        <div class="text-xs text-gray-600">Processados</div>
                                    </div>
                                    <div class="bg-white p-2 rounded border">
                                        <div class="text-lg font-bold <?php echo e($lotesPendentes > 0 ? 'text-orange-600' : 'text-gray-400'); ?>" id="contador-pendentes"><?php echo e($lotesPendentes); ?></div>
                                        <div class="text-xs text-gray-600">Pendentes</div>
                                    </div>
                                </div>

                                <?php if($lotesProcessados > 0): ?>
                    ...
                    <div class="p-4">
                        ...
                        <?php $__currentLoopData = $todosTipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoId => $dadosTipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $tipo = $dadosTipo['tipo'];
                            ...
                            <div class="tipo-peca-container border border-gray-200 rounded-lg overflow-hidden mb-4">
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div class="checkbox-selecao-tipo hidden">
                                                <label for="tipo_<?php echo e($tipoId); ?>" class="flex items-center cursor-pointer" onclick="event.stopPropagation()">
                                                    <input type="checkbox"
                                                           name="tipos_selecionados[]"
                                                           value="<?php echo e($tipoId); ?>"
                                                           id="tipo_<?php echo e($tipoId); ?>"
                                            ...
                                            <div>
                                                <div class="flex items-center">
                                                    <h5 class="text-sm font-semibold text-gray-900"><?php echo e($tipo->nome); ?></h5>
                                                    <?php if($lotesPendentesTipo > 0): ?>
                                                        <span class="ml-2 inline-flex items-center px-1.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">
                                                            ...
                                                            <?php echo e($lotesPendentesTipo); ?> pendente<?php echo e($lotesPendentesTipo > 1 ? 's' : ''); ?>

                                                        </span>
                                                    <?php endif; ?>
                                                </div>
                                                <p class="text-xs text-gray-500"><?php echo e($tipo->categoria); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="text-right">
                                                ...
                                                <div class="text-sm font-medium text-blue-600">
                                                    <?php echo e($pecasEmpacotadas->count()); ?> lotes
                                                    <?php
                                                        $lotesProcessados = $pecasEmpacotadas->where('quantidade', '>', 0)->count();
                                                    ?>
                                                    <?php if($lotesProcessados > 0): ?>
                                                        <div class="text-xs text-green-600 font-medium">
                                                            <?php echo e($lotesProcessados); ?> processado<?php echo e($lotesProcessados > 1 ? 's' : ''); ?>

                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <?php if($quantidadeColetada > 0 && $totalEmpacotado == 0): ?>
                                                <button type="button"
                                                        onclick="event.stopPropagation(); criarLoteInicial('<?php echo e($tipoId); ?>', '<?php echo e($tipo->nome); ?>')"
                                            ...
                                            <?php elseif($lotesPendentesTipo > 0): ?>
                                                <button type="button"
                                                        onclick="event.stopPropagation(); preencherLotesTipo('<?php echo e($tipoId); ?>', <?php echo e($lotesPendentesTipo); ?>)"
                                ...
                                <div id="content-<?php echo e($tipoId); ?>" class="tipo-peca-content hidden bg-white">
                                    <div class="p-4">
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <?php if($lotesProcessados > 0): ?>
                                                    <div class="flex items-center text-xs text-green-600 bg-green-50 px-2 py-1 rounded">
                                                        ...
                                                        <?php echo e($lotesProcessados); ?> de <?php echo e($totalLotes); ?> lotes já processados
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="space-y-3">
                                            <?php if($pecasEmpacotadas->count() > 0): ?>
                                                <?php $__currentLoopData = $pecasEmpacotadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $peca): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="lote-empacotamento flex items-center space-x-3 p-3 rounded border <?php echo e($peca->quantidade > 0 ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'); ?>">
                                                    <!-- Badge de Status -->
                                                    ...
                                                    <div class="flex-1 grid grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-mono font-medium <?php echo e($peca->quantidade > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="number"
                                                                   ...
                                                                   value="<?php echo e($peca->quantidade); ?>"
                                                                   min="0"
                                                                   data-tipo-id="<?php echo e($tipoId); ?>"
                                                                   data-quantidade-original="<?php echo e($peca->quantidade); ?>"
                                                                   onchange="atualizarStatusTipo('<?php echo e($tipoId); ?>')"
                                                                   oninput="atualizarStatusTipo('<?php echo e($tipoId); ?>')"
                                                                   class="quantidade-lote w-full px-2 py-1 text-center border border-gray-300 rounded text-sm focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 <?php echo e($peca->quantidade > 0 ? 'bg-green-50 border-green-300 font-semibold text-green-800' : ''); ?>">
                                                            ...
                                                            <?php if($peca->quantidade > 0): ?>
                                                                <div class="mt-1 text-xs text-green-600">
                                                                    ...
                                                                    Este lote já foi empacotado com <?php echo e($peca->quantidade); ?> peça<?php echo e($peca->quantidade > 1 ? 's' : ''); ?>

                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <?php if($pecasEmpacotadas->count() > 1): ?>
                                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="mt-4 pt-3 border-t border-gray-200">
                                            <button type="button" onclick="duplicarLoteEdicao('<?php echo e($tipoId); ?>', '<?php echo e($tipo->nome); ?>')"
