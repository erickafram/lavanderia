...
<?php $__env->startSection('title', 'Consulte sua Coleta'); ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative group">
                            <input type="text" 
                                   ...
                                   class="w-full px-4 py-4 text-sm border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-300 bg-gray-50/50 hover:bg-white group-hover:shadow-lg <?php $__errorArgs = ['busca'];
...
unset($__errorArgs, $__bag); ?> placeholder-gray-400"
