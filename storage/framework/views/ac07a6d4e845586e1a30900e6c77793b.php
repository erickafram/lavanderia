...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm <?php $__errorArgs = ['observacoes_gerais'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Observações gerais sobre a pesagem..."><?php echo e(old('observacoes_gerais', $pesagem->observacoes)); ?></textarea>
                            <?php $__errorArgs = ['observacoes_gerais'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-4 space-y-3">
                    <div>
                        ...
                        <div class="text-blue-600 font-semibold"><?php echo e($pesagem->coleta->numero_coleta); ?></div>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-700">Estabelecimento:</span>
                        <div class="text-gray-900 text-sm"><?php echo e($pesagem->coleta->estabelecimento->razao_social); ?></div>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-700">Status:</span>
                        <div class="mt-1">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-4 space-y-3">
                    <div>
                        ...
                        <div class="text-gray-900 text-sm"><?php echo e($pesagem->usuario->nome); ?></div>
                    </div>
                    <div>
                    ...
                    <?php if($pesagem->updated_at != $pesagem->created_at): ?>
                        <div>
                            ...
                            <div class="text-gray-900 text-sm"><?php echo e($pesagem->updated_at->format('d/m/Y H:i')); ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div class="p-4 space-y-3">
                    <div class="flex justify-between items-center">
                        ...
                        <span id="calcPesoTotal" class="text-sm font-bold text-blue-600"><?php echo e($pesagem->peso_formatado); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm font-medium text-gray-700">Peso Unitário:</span>
                        <span id="calcPesoUnitario" class="text-sm font-bold text-indigo-600"><?php echo e($pesagem->peso_unitario_formatado); ?></span>
                    </div>
                    <div class="flex justify-between items-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const baseUrl = '<?php echo e(url("coletas")); ?>';
    ...
    function carregarDadosColeta() {
        ...
        fetch(`${baseUrl}/${coletaId}/pecas`)
            ...
            .then(data => {
                ...
                // Atualizar informações da coleta no card principal se existir
                if (dadosColeta) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderia\resources\views/pesagem/edit.blade.php ENDPATH**/ ?>