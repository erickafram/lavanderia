...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        ...
        <div class="flex gap-2 mt-3 sm:mt-0">
            <a href="<?php echo e(route('empacotamento.create')); ?>" 
                    ...
                    <div>
                        ...
                        <select name="motorista_id" id="motorista_id" 
                            ...
                            <?php $__currentLoopData = $motoristas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $motorista): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($motorista->id); ?>" <?php echo e(request('motorista_id') == $motorista->id ? 'selected' : ''); ?>>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <?php if($empacotamentos->count() > 0): ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        <?php echo e($empacotamento->motorista->nome ?? 'Não definido'); ?>
            ...
            <div class="px-6 py-4 border-t border-gray-200">
                <?php echo e($empacotamentos->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\lavanderianovo\resources\views/empacotamento/index.blade.php ENDPATH**/ ?>